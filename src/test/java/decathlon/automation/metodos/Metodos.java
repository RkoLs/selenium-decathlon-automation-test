...
public class Metodos extends DriverFactory {
	...
	public static void selecionarProduto() {
		clicar(By.xpath("//img[@src=\"https://decathlonstore.vtexassets.com/unsafe/302x302/center/middle/"
				+ "https%3A%2F%2Fdecathlonpro.vtexassets.com%2Farquivos%2Fids%2F65808214%2F-tn-adidas-boston-12-m-az-uk-11---eu-46-44-br1.jpg"
				+ "%3Fv%3D638328183246400000\"]"));
	...
	public static void consultarCarrinho() {
		...
		WebElement tituloCarrinho = driver.findElement(By.xpath("//*[@class='title-display']"));
		String textoEsperado = "meu carrinho";
		String textoAtual = tituloCarrinho.getText();
		if (!textoAtual.equalsIgnoreCase(textoEsperado)) {
			throw new AssertionError("Texto esperado: " + textoEsperado + " mas foi: " + textoAtual);
		}
	}
}
